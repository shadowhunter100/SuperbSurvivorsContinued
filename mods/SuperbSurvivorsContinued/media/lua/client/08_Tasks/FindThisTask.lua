...
function FindThisTask:update()
	...
	if (self.TargetItem == nil) then
		...
		if (self.WasSuccessful == false) then
			self.parent:RoleplaySpeak(getActionText("NoFindItem_Before") ..
				self.itemtype .. getActionText("NoFindItem_After"))
		end
				...
				if (self.BagToPutIn:contains(self.TargetItem) == false) then
					if (self.TargetItem:getWorldItem() ~= nil) then
						...
						self.parent:RoleplaySpeak(getActionText("TakesFromGround_Before") ..
							self.TargetItem:getDisplayName() .. getActionText("TakesFromGround_After"))
								...
								if (tempWitem ~= nil) then
									...
									if (tempitem ~= nil) then
										if (tempitem:getType() == self.itemtype) or (tempitem:getCategory() == self.itemtype) then
											...
											self.parent:RoleplaySpeak(getActionText("TakesFromGround_Before") ..
												tempitem:getDisplayName() .. getActionText("TakesFromGround_After"))
											self.FoundCount = self.FoundCount + 1
						...
						self.parent:RoleplaySpeak(getActionText("TakesFromCont_Before") ..
							self.TargetItem:getDisplayName() .. getActionText("TakesFromCont_After"))
						self.FoundCount = self.FoundCount + 1
					end
				else
					self.FoundCount = self.FoundCount + 1
