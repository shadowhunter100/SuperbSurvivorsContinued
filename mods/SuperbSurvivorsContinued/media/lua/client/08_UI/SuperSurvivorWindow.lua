...
context_options.show_context_menu_role = function(member_index)
    ...
    sub_order:addOption("Lock Doors", nil, function() UIUtil_GiveOrder(14, member_index) end)
    sub_order:addOption("Loot Room", nil, function() UIUtil_GiveOrder(15, member_index) end)
    sub_order:addOption("Patrol", nil, function() UIUtil_GiveOrder(16, member_index) end)
    sub_order:addOption("Sort Loot Into Base", nil, function() UIUtil_GiveOrder(17, member_index) end)
    sub_order:addOption("Stand Ground", nil, function() UIUtil_GiveOrder(18, member_index) end)
    sub_order:addOption("Stop", nil, function() UIUtil_GiveOrder(19, member_index) end)
    sub_order:addOption("Dismiss", nil, function() UIUtil_GiveOrder(20, member_index) end)
