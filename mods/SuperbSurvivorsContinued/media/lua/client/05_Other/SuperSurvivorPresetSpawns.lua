...
PresetSpawns[#PresetSpawns + 1] = {
	GroupID = WoodburyGroupID,
	Role = "Leader",
	Greeting = "In this life now you kill or you die. Or you die and you kill",
	PerkName = "Aiming",
	PerkLevel = 5,
	isFemale = false,
	Name = "The Governor",
...
PresetSpawns[#PresetSpawns + 1] = {
	GroupID = WoodburyGroupID,
	Greeting = "Best be on your way now",
	InitGreeting = getText("ContextMenu_speech_DoNotTouchFood"),
	PerkName = "Aiming",
	PerkLevel = 2,
	NoParty = true,
	Name = "Food Guard",
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Leader",
	GroupID = HillTopGroupID,
	Role = "Leader",
	NoParty = true,
	Greeting = "We saw this coming a long time ago, and set up this community",
	InitGreeting = getText("ContextMenu_speech_HilltopIntro"),
	Name = "Hilltop Governor",
	X = 11729,
	Y = 7935,
	Z = 0,
	Weapon = getWeapon("Base.Pistol"),
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	NoParty = true,
	Name = "Hilltop Scout",
	InitGreeting = getText("ContextMenu_speech_FollowMeToHilltop"),
	X = 10839,
	Y = 9536,
	Z = 0,
	Weapon = "Base.HuntingKnife",
	Orders = "FollowRoute",
	RouteID = "MuldToHilltop",
	isHostile = false,
	AIMode = ""
}
PresetSpawns[#PresetSpawns + 1] = {
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	Role = "Doctor",
	NoParty = true,
	Greeting = "If you need some medical treatment, stop by anytime.",
	Role = "Doctor",
	Name = getText("ContextMenu_SD_DoctorPrefix_Before") .. "Hilltop" .. getText("ContextMenu_SD_DoctorPrefix_After"),
	X = 11722,
	Y = 7942,
	Z = 0,
	PerkName = "Doctor",
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Leader",
	GroupID = Gang1GroupID,
	Greeting = "Look man, it\'s nothing personal!",
	Name = "Gang Leader",
	X = 11367,
	Y = 7024,
	Z = 0,
...
PresetSpawns[#PresetSpawns + 1] = {
	RouteID = "TrainTracksToValleyStation",
	GroupID = Gang2GroupID,
	Name = "Bandit",
	X = BaseX,
	Y = BaseY,
	Z = 0,
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	RouteID = "TrainTracksToValleyStation",
	GroupID = Gang2GroupID,
	Greeting = "Look! There is someone! Get Him!",
	Name = "Bandits Leader",
	X = BaseX - 1,
	Y = BaseY,
	Z = 0,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Gangster",
	GroupID = LoslokosGroupID,
	Name = "Loslokos Gang Member",
	X = 11660,
	Y = 7039,
	Z = 0,
	Weapon = "Base.HuntingKnife",
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Leader",
	GroupID = LoslokosGroupID,
	Greeting = "Amigo. We will be taking all your stuff. Gracias",
	Name = "Loslokos Gang Leader",
	X = 11659,
	Y = 7040,
	Z = 0,
	Weapon = "Base.Sledgehammer",
	Orders = "Guard",
	isHostile = true
};
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Farmer",
	GroupID = BlockadeGroupID,
	NoParty = true,
	Role = "Farmer",
	Name = "Freelance Farmer",
	X = 12483,
	Y = 4442,
	Z = 0,
	PerkName = "Farming",
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Role = "Leader",
	InitGreeting = getText("ContextMenu_speech_BlockadeIntro"),
	PerkName = "Aiming",
	PerkLevel = 10,
	NoParty = true,
	isFemale = false,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Greeting = "You\'re not supposed to be up here, Move along!",
	PerkName = "Aiming",
	PerkLevel = 10,
	NoParty = true,
	isFemale = false,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Greeting = "What are you doing up here? Move along!",
	PerkName = "Aiming",
	PerkLevel = 10,
	NoParty = true,
	isFemale = false,
...
PresetSpawns[#PresetSpawns + 1] = {
	GroupID = BlockadeGroupID,
	Greeting = "I can\'t get a good signal",
	NoParty = true,
	isFemale = false,
	Name = "Refugee Bob",
	X = 12485,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Greeting = "We cannot wait any longer! We must proceed with operation Bluejay NOW!",
	PerkName = "Aiming",
	isFemale = false,
	PerkLevel = 2,
	NoParty = true,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Greeting = "Communication has been down for far too long. We must assume the worst.",
	PerkName = "Aiming",
	isFemale = false,
	PerkLevel = 2,
	NoParty = true,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_ArmyCamo",
	GroupID = BlockadeGroupID,
	Greeting = "We can\'t hold off here without backup for much longer. We need to do something!",
	PerkName = "Aiming",
	isFemale = false,
	PerkLevel = 2,
	NoParty = true,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	GroupID = BlockadeGroupID,
	Greeting = "No one may pass the Blockade. NO exceptions!",
	PerkName = "Aiming",
	PerkLevel = 5,
	NoParty = true,
	isFemale = false,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	GroupID = BlockadeGroupID,
	Greeting = "Talk to the General up by the North West Entrance",
	PerkName = "Aiming",
	isFemale = false,
	PerkLevel = 2,
	NoParty = true,
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	PerkLevel = 3,
	NoParty = true,
	Name = getText("ContextMenu_SD_DoctorPrefix_Before") .. "Dan" .. getText("ContextMenu_SD_DoctorPrefix_After"),
	X = 12483,
	Y = 4457,
	Z = 0,
	Weapon = getWeapon("Base.HuntingKnife"),
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	GroupID = BlockadeGroupID,
	NoParty = true,
	Greeting = "I\'m supposed to take down all these trees.",
	PerkName = "Axe",
	PerkLevel = 5,
	Name = "Worker",
	X = 12555,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	GroupID = BlockadeGroupID,
	Greeting = "I tried to warn everyone, no one would listen.",
	PerkName = "Aiming",
	PerkLevel = 6,
	Name = "Private Manning",
	X = 12467,
	Y = 4409,
	Z = 0,
	Weapon = getWeapon("Base.AssaultRifle"),
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	roupID = BlockadeGroupID,
	Greeting = "Hey! Your not aloud in here!",
	PerkName = "Aiming",
	PerkLevel = 5,
	NoParty = true,
	isFemale = false,
...
PresetSpawns[#PresetSpawns + 1] = {
	...
	GroupID = BlockadeGroupID,
	Greeting =
	"This is the North East Blockade. No one is aloud past the rear Blockade. Lethal force will be used if necessary",
	PerkName = "Aiming",
	PerkLevel = 10,
	NoParty = true,
	isFemale = false,
	Name = "Captain B.J. Blazkowicz",
	X = 12508,
	Y = (-2 * 300) + 4487,
	Z = 0,
	Weapon = getWeapon("Base.AssaultRifle"),
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	GroupID = BlockadeGroupID,
	Greeting = "Talk to the Captain up by the North West Entrance",
	PerkName = "Aiming",
	isFemale = false,
	PerkLevel = 2,
	NoParty = true,
...
PresetSpawns[#PresetSpawns + 1] = {
	Suit = "Preset_Army",
	GroupID = BlockadeGroupID,
	Greeting = "Hey! Your not allowed in here!",
	PerkName = "Aiming",
	PerkLevel = 5,
	NoParty = true,
	isFemale = false,
