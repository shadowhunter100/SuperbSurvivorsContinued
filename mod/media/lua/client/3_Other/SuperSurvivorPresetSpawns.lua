require "2_Other\SuperSurvivorGroupManager"
...
PresetSpawns[#PresetSpawns+1] = {Suit="Spiffo", Name = "Spiffo Mascott", X = 6123, Y = 5302, Z = 0 , Weapon = getWeapon("Base.SpearKnife"), Orders = "Standing Ground", isHostile = false};

PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 9571, Y = 11161, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 8061, Y = 7629, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 13617, Y = 7224, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 12793, Y = 5728, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 12864, Y = 6776, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 10722, Y = 9229, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I thought it better I do things alone",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 10155, Y = 9338, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Worker", Greeting = "Bill here is an Idiot",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Bob", X = 10077, Y = 9545, Z = 0 , Weapon = "Base.ClubHammer", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Worker", Greeting = "Breaks over time to get back to work....haha JK",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Bill", X = 10075, Y = 9545, Z = 0 , Weapon = "Base.Shovel", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Hazmat", Greeting = "I new all this would happen.", Name = "Nolan", X = 11690, Y = 8363, Z = 0 , Weapon = getWeapon("Base.Pistol"), isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Santa", Greeting = "Hoho hoo, Merry Christmass", Name = "Santa", X = 1018, Y = 6765, Z = 0 , Weapon = getWeapon("Base.Shotgun"), isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit="Spiffo", Name = "Spiffo Mascott", X = 11979, Y = 6816, Z = 0 , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit="Police", Name = "Prison Guard", X = 11899, Y = 6937, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Standing Ground", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit="Police", Greeting = "YOU WANT SOME?! I\'LL TAKE YOU ALL DOWN!", Name = "Prison Guard", X = 11900, Y = 6937, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Standing Ground", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit="Police", ChanceToSpawn=75,  Name = "Prison Guard", X = 11901, Y = 6937, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Standing Ground", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Formal", Greeting = "Pastor Bob was right, all us sinners are having to pay!", Name = "Giga Shop Owner", X = 12033, Y = 6849, Z = 1 , Weapon = "Base.Screwdriver", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Formal", Greeting = "Bonjour! Rooms are now free. Do you have somewhere better to stay?", Name = "Hotel Manager", X = 12009, Y = 6919, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster",  Name = "Thug", X = 12310, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster",  Name = "Thug", X = 12313, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster",  Name = "Thug", X = 12316, Y = 6729, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=0,PY=-5};

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Formal", Name = "Principal", X = 11327, Y = 6765, Z = 1 , Weapon = "Base.Plank", Orders = "Patrol", isHostile = false, Patrolling=true, PX=2,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {GroupID = WoodburyGroupID,Role="Leader", Greeting = "In this life now you kill or you die. Or you die and you kill",PerkName = "Aiming",PerkLevel = 5,isFemale = false,  Name = "The Governor", X = 12096, Y = 6939, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit="Leader",GroupID = HillTopGroupID,Role="Leader", NoParty = true, Greeting = "We saw this coming a long time ago, and set up this community",InitGreeting=getText("ContextMenu_speech_HilltopIntro"), Name = "Hilltop Governor", X = 11729, Y = 7935, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Stand Ground", isHostile = false, AIMode = "Stand Ground",Role="Leader"}
PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, Role="Guard",PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11708, Y = 7938, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, Role="Guard",PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11711, Y = 7941, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Role = "Guard", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, Role="Guard",PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11711, Y = 7944, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID, Role="Guard",PerkName = "Aiming",PerkLevel = 2, NoParty = true,  Name = "Hilltop Guard", X = 11708, Y = 7946, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Role = "Guard", isHostile = false, AIMode = ""}
...
PresetSpawns[#PresetSpawns+1] = {GroupID = HillTopGroupID,Role="Guard", NoParty = true,  Name = "Hilltop Guard", X = 11711, Y = 7943, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", GroupID = HillTopGroupID, Role="Doctor",NoParty = true, Greeting = "If you need some medical treatment, stop by anytime.", Role="Doctor",Name = getText("ContextMenu_SD_DoctorPrefix_Before").."Hilltop"..getText("ContextMenu_SD_DoctorPrefix_After"), X = 11722, Y = 7942, Z = 0 , PerkName="Doctor",PerkLevel=3, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false, AIMode = ""}
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Farmer", GroupID = HillTopGroupID, Role="Farmer",NoParty = true, Role="Farmer",Name = "Hilltop Farmer", X = 11733, Y = 7936, Z = 0 , PerkName="Farming",PerkLevel=5, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Farming", isHostile = false}
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=Gang1GroupID, Name = "Gang Member1", X = 11373, Y = 7034, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true };  
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=Gang1GroupID,  Name = "Gang Member2", X = 11370, Y = 7036, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= 10,PY=0};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=Gang1GroupID,  Name = "Gang Member3", X = 11374, Y = 7027, Z = 0 , Weapon = "Base.Shotgun", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= 0,PY=2};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=Gang1GroupID,  Name = "Gang Member4", X = 11364, Y = 7024, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= -1,PY=0};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=Gang1GroupID,  Name = "Gang Member5", X = 11365, Y = 7032, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true,Orders = "Patrol", Patrolling=true, PX= -13,PY=0};
PresetSpawns[#PresetSpawns+1] = {Suit="Leader",GroupID=Gang1GroupID,Greeting = "Look man, it\'s nothing personal!", Name = "Gang Leader", X = 11367, Y = 7024, Z = 0 , Weapon = "Base.Pistol", Orders = "Guard", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", RouteID="TrainTracksToValleyStation",GroupID=Gang2GroupID,  Name = "Bandit", X = BaseX, Y = BaseY+1, Z = 0 , Weapon = "Base.Shotgun", Orders = "FollowRoute", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", RouteID="TrainTracksToValleyStation",GroupID=Gang2GroupID,  Name = "Bandit", X = BaseX+1, Y = BaseY+1, Z = 0 , Weapon = "Base.Shotgun", Orders = "FollowRoute", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit="Leader", RouteID="TrainTracksToValleyStation",GroupID=Gang2GroupID, Greeting = "Look! There is someone! Get Him!", Name = "Bandits Leader", X = BaseX-1, Y = BaseY, Z = 0 , Weapon = "Base.Pistol", Orders = "FollowRoute", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=LoslokosGroupID, Name = "Loslokos Gang Member", X = 11660, Y = 7039, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11660, Y = 7041, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11660, Y = 7040, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11659, Y = 7039, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Gangster", GroupID=LoslokosGroupID,  Name = "Loslokos Gang Member", X = 11659, Y = 7041, Z = 0 , Weapon = "Base.HuntingKnife", Orders = "Guard", isHostile = true};
PresetSpawns[#PresetSpawns+1] = {Suit="Leader", GroupID=LoslokosGroupID, Greeting = "Amigo. We will be taking all your stuff. Gracias", Name = "Loslokos Gang Leader", X = 11659, Y = 7040, Z = 0 , Weapon = "Base.Sledgehammer", Orders = "Guard", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Greeting = "Shit, she is not anwering her phone...",PerkName = "Blunt",PerkLevel = 5, Name = "Mechanic", X = 11894, Y = 6804, Z = 0 , Weapon = "Base.Wrench", isHostile = false, Orders = "Patrol", Patrolling=true, PX=10,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Formal", Greeting = "Praise God! Hallelujah!",isFemale = false,  Name = "Pastor Bob", X = 11973, Y = 6990, Z = 0 , Weapon = "Base.Plank", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Formal", Greeting = "He has sent me a miracle. Amen!",isFemale = false,  Name = "Pastor Aaron", X = 11096, Y = 6710, Z = 0 , Weapon = "Base.Plank", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Fireman", Greeting = "As you can tell, I\'m an axe man",PerkName = "Axe",PerkLevel = 5,  Name = "Lumberjack", X = 12064, Y = 7213, Z = 0 , Weapon = "Base.Axe", Orders = "Chop Wood", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "Could have been the Russians, aliens, some secret military experiments",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 12074, Y = 7306, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Forage", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit="Survivalist", Greeting = "I focused on being prepared. Crazy is building the ark after the flood has already come. Don\'t you agree?",PerkName = "PlantScavenging",PerkLevel = 5,   Name = "Survivalist", X = 12084, Y = 7306, Z = 0 , Weapon = "Base.SpearKnife", Orders = "Explore", isHostile = false};

-- WESTPOINT END PlantScavenging 

-- MULDRAUGH BEGIN

PresetSpawns[#PresetSpawns+1] = {Greeting = "All life is precious",PerkName = "Blunt",PerkLevel = 10, isFemale=false, NoParty = true,   Name = "Morgan", X = 9834, Y = 9515, Z = 0 , Weapon = "Base.WoodenLance", Orders = "Guard", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", Greeting = "Doctor Kildare? Oh.. how did you get up here? The doors should have been locked. Are you bitten?",PerkName = "Doctor",PerkLevel = 3,isFemale=true,  Name = "Nurse", X = 10880, Y = 10029, Z = 1 , Weapon = "Base.KitchenKnife", Orders = "Doctor", isHostile = false}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", Greeting = "We\'ve got to get out of here! Its not safe. There is a gang of lunatics coming back here for me and the supplies. They want a doctor",isFemale=true, PerkLevel = 4, PerkName = "Doctor", Name = "Doctor", X = 10167, Y = 12754, Z = 0 , Weapon = "Base.BaseballBat", Orders = "Doctor", isHostile = false};

--MARCH RIDGE END

--ROSEWOOD 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Fireman", Greeting = "Howdy. You can call me Tex. Been waiting for the military or some such, but you\'ll do my friend. Welcome!",PerkName = "Axe",PerkLevel = 5,isFemale=false,  Name = "Fire Fighter", X = 8143, Y = 11736, Z = 1 , Weapon = "Base.Axe", Orders = "Standing Ground", isHostile = false};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Hunter", Greeting = "I\'ve have been watching you, but you seem friendly. How did you make it out alive?",PerkName = "Aiming",PerkLevel = 7,isFemale=false,  Name = "Hunter", X = 12475, Y = 8969, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Patrol", isHostile = false,Patrolling=true, PX=10,PY=0};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Worker", Greeting = "Ya better be real cool buddy, or I\'ll shovel your sorry ass outta here.",PerkName = "Blunt",PerkLevel = 3,isFemale=false,  Name = "Construction Worker", X = 14087, Y = 5453, Z = 0 , Weapon = "Base.Shovel", Orders = "Standing Ground", isHostile = false};
...
-- NORTH EAST BLOCKADE
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Farmer", GroupID = BlockadeGroupID, NoParty = true, Role="Farmer",Name = "Freelance Farmer", X = 12483, Y = 4442, Z = 0 , PerkName="Farming",PerkLevel=5, Weapon = getWeapon("Base.HuntingKnife"), Orders = "Farming", isHostile = false}
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Role="Leader", InitGreeting = getText("ContextMenu_speech_BlockadeIntro"), PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "General Carter", X = 12508, Y = 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = 4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Cook", GroupID = BlockadeGroupID, Greeting = "I\'m busy", NoParty = true, isFemale=false,   Name = "Cook", X = 12481, Y = 4446, Z = 0 , Weapon = "Base.KitchenKnife", Orders = "Patrol", isHostile = false, Patrolling=true, PX=-4,PY=-8}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12541, Y = 4456, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=0,PZ=1}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We cannot wait any longer! We must proceed with operation Bluejay NOW!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Captian", X = 12540, Y = 4402, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Communication has been down for far too long. We must assume the worst.", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Major Mike", X = 12533, Y = 4405, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We can\'t hold off here without backup for much longer. We need to do something!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Lt. Dan", X = 12533, Y = 4407, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = 4400, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12515, Y = 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Go No Futher!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12519, Y = 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12508, Y = 4397, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12505, Y = 4417, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=0}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12470, Y = 4425, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=17}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12552, Y = 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Go No Further!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12556, Y = 4458, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "Talk to the General up by the North West Entrance", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Srgt. Sam", X = 12552, Y = 4498, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", GroupID = BlockadeGroupID, Greeting = "Need some treatment?", PerkName = "Doctor", isFemale=false, PerkLevel = 3, NoParty = true,   Name = getText("ContextMenu_SD_DoctorPrefix_Before").."Dan"..getText("ContextMenu_SD_DoctorPrefix_After"), X = 12483, Y = 4457, Z = 0 , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12555, Y = 4498, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Worker", GroupID = BlockadeGroupID, NoParty=true,Greeting = "I\'m supposed to take down all these trees.",PerkName = "Axe",PerkLevel = 5,  Name = "Worker", X = 12555, Y = 4478, Z = 0 , Weapon = "Base.Axe", Orders = "Explore", isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "I tried to warn everyone, no one would listen.",PerkName = "Aiming",PerkLevel = 6,  Name = "Private Manning", X = 12467, Y = 4409, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol",  Patrolling=true, PX=0,PY=9, isHostile = false};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", roupID = BlockadeGroupID, Greeting="Hey! Your not aloud in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12497, Y = 4366, Z = 3 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-4,PY=-7}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Hey! Your not aloud in here!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12537, Y = 4368, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = true, Patrolling=true, PX=-25,PY=1}; 
...
PresetSpawns[#PresetSpawns+1] = {  Name = "A Savior", X = 8248, Y = 11859, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = true};
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "This is the North East Blockade. No one is aloud past the rear Blockade. Lethal force will be used if necessary", PerkName = "Aiming",PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Captain B.J. Blazkowicz", X = 12508, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = (-2*300) + 4487, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12517, Y = (-2*300) +4487, Z = 0 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "You\'re not supposed to be up here, Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12499, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "What are you doing up here? Move along!", PerkName = "Aiming", PerkLevel = 10, NoParty = true, isFemale=false,   Name = "Sniper", X = 12527, Y = (-2*300) + 4497, Z = 3 , Weapon = getWeapon("Base.HuntingRifle"), Orders = "Standing Ground", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true, isFemale=false,   Name = "Soldier", X = 12527, Y = (-2*300) + 4485, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=-35,PY=-13}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Cook", GroupID = BlockadeGroupID, Greeting = "I\'m busy", NoParty = true, isFemale=false,   Name = "Cook", X = 12481, Y = (-2*300) + 4446, Z = 0 , Weapon = "Base.KitchenKnife", Orders = "Patrol", isHostile = false, Patrolling=true, PX=-4,PY=-8}; 
...
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "I\'m busy", PerkName = "Aiming", PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12541, Y = (-2*300) + 4456, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=0,PZ=1}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We cannot wait any longer! We must proceed with operation Bluejay NOW!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Captian", X = 12540, Y = (-2*300) + 4402, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "Communication has been down for far too long. We must assume the worst.", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Major Mike", X = 12533, Y = (-2*300) + 4405, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_ArmyCamo", GroupID = BlockadeGroupID, Greeting = "We can\'t hold off here without backup for much longer. We need to do something!", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Lt. Dan", X = 12533, Y = (-2*300) + 4407, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = false}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12512, Y = (-2*300) + 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12515, Y = (-2*300) + 4400, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Go No Futher!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12519, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12508, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12505, Y = (-2*300) + 4417, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=0}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "No one may pass the Blockade. NO exceptions!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12470, Y = (-2*300) + 4425, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Patrol", isHostile = false, Patrolling=true, PX=15,PY=17}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12552, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting="Go No Further!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 12556, Y = (-2*300) + 4397, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "Talk to the Captain up by the North West Entrance", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Srgt. Sam", X = 12552, Y = (-2*300) + 4498, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Army", GroupID = BlockadeGroupID, Greeting = "Move along now", PerkName = "Aiming", isFemale=false, PerkLevel = 2, NoParty = true,   Name = "Soldier", X = 12555, Y = (-2*300) + 4498, Z = 0 , Weapon = getWeapon("Base.AssaultRifle"), Orders = "Guard", isHostile = false}; 
...
-- prison
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7753, Y = 11884, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7753, Y = 11889, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Standing Ground", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7743, Y = 11905, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Guard", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7709, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Guard", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7680, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7680, Y = 11878, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7651, Y = 11855, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7651, Y = 11855, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Halt!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7729, Y = 11913, Z = 0 , Weapon = getWeapon("Base.Shotgun"), Orders = "Explore", isHostile = true}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Guard", Greeting="Stop!",PerkName = "Aiming", PerkLevel = 5, NoParty = true, isFemale=false,   Name = "Soldier", X = 7729, Y = 11913, Z = 0 , Weapon = getWeapon("Base.Pistol"), Orders = "Explore", isHostile = true}; 

--recruitable farmers
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Farmer", Greeting = "You\'re the one stealing my crops? I\'m sure it was no damn zombie. These city folk don\'t know how to fend for themselves. We can work together here",isFemale = false, PerkName="Farming",PerkLevel=5,  Name = "Farmer John", X = 11137, Y = 6855, Z = 1 , Weapon = "Base.Hammer",  Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=-4};
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Farmer", Greeting = "I bet you could use someone who knows about farming. If you make it worth my while I just might go with you.",isFemale = false, PerkName="Farming",PerkLevel=5,  Name = "Farmer Nick", X = 8616, Y = 8823, Z = 0 , Weapon = "Base.Hammer",  Orders = "Patrol", isHostile = false, Patrolling=true, PX=0,PY=-4};
...
--recuritable doctors
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 10877, Y = 10029, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 8093, Y = 11521, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor",  PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 11882, Y = 6883, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 11937, Y = 6797, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 10143, Y = 12750, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
PresetSpawns[#PresetSpawns+1] = {Suit = "Preset_Doctor", X = 6477, Y = 5259, Z = 0, Greeting = "Need some treatment?", PerkName = "Doctor", PerkLevel = 5,isFemale=false, Name = getText("ContextMenu_SD_DoctorPrefix_Before")..getSpeech("BoyNames")..getText("ContextMenu_SD_DoctorPrefix_After") , Weapon = getWeapon("Base.HuntingKnife"), Orders = "Doctor", isHostile = false}; 
...
function SuperSurvivorPresetSpawnThis(PresetSpawn)
			...
			if(PresetSpawn.isItemSpawn ~= nil) and (PresetSpawn.itemType ~= nil) then
				...
				if(PresetSpawn.Patrolling ~= nil) then
					local patrolSquare = getCell():getGridSquare(x + PresetSpawn.PX,y + PresetSpawn.PY,PresetSpawn.Z)				
				...
				if(PresetSpawn.PerkLevel ~= nil and PresetSpawn.PerkName ~= nil) then
					...
					if perk and (tostring(perk) ~= "MAX") then
						if(PresetSpawn.PerkLevel == nil) then level = ZombRand(3,9)
						else level = PresetSpawn.PerkLevel end
						local count = 0;
